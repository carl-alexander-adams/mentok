...
nativecode_toolchain_kernmod_info:
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_KERNMON_OBJ                   $(EXTENSIONS_KERNMON_OBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_KERNMON_EXE                   $(EXTENSIONS_KERNMON_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_KERNMON_LIB                   $(EXTENSIONS_KERNMON_LIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_KERNMON_SHLIB                 $(EXTENSIONS_KERNMON_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
