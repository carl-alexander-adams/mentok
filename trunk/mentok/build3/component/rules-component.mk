...
_IMPORT_FUNC_COMPUTE_TARGETDIR=$(strip $(if $($(1)_TO),$($(1)_TO),$(subst $(call _IMPORT_FUNC_COMPUTE_DISTROOT,$(1)),$(COMPONENT_IMPORT_TARGET_ROOT),$(call _IMPORT_FUNC_COMPUTE_FROMPATH,$(1)))))
