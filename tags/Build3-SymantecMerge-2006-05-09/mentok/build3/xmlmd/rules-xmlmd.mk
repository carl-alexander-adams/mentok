...
XMLMD_FUNC_GET_XML_VALIDATE_FLAGTARGET=$(BS_NOARCH_TARGET_DIR)/xmlmd_flags_validate/$(1)
...
_XML_VALIDATE_DEPEND_FILE=$(BS_NOARCH_TARGET_DIR)/xmlmd_depend_validate_noarch.mk
...
_XML_VALIDATE_DEP_PREP:
	...
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_NOARCH_TARGET_DIR)/xmlmd_flags_validate
...
XMLMD_FUNC_GET_TRANSFORM_FLAGTARGET=$(BS_NOARCH_TARGET_DIR)/xmlmd_flags_transform/$(1)

_XML_TRANSFORM_DEPEND_FILE=$(BS_NOARCH_TARGET_DIR)/xmlmd_depend_transform_noarch.mk
...
_XML_TRANSFORM_DEP_PREP:
	...
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_NOARCH_TARGET_DIR)/xmlmd_flags_transform
...
XMLMD_FUNC_GET_TFS_FLAGTARGET=$(BS_NOARCH_TARGET_DIR)/xmlmd_flags_tfsplit/$(1)

_XML_TFSPLIT_DEPEND_FILE=$(BS_NOARCH_TARGET_DIR)/xmlmd_depend_tfsplit_noarch.mk
...
_XML_TFSPLIT_DEP_PREP:
	...
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_NOARCH_TARGET_DIR)/xmlmd_flags_tfsplit
