...
base_info:
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_ROOT_TARGET_DIR_ABSPATH         $(BS_ROOT_TARGET_DIR_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_ARCH_DEPEND_DIR                 $(BS_ARCH_DEPEND_DIR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_ARCH_DEPEND_DIR_ABSPATH         $(BS_ARCH_DEPEND_DIR_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_ARCH_FLAG_DIR                   $(BS_ARCH_FLAG_DIR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_ARCH_FLAG_DIR_ABSPATH           $(BS_ARCH_FLAG_DIR_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_TARGET_DIR               $(BS_NOARCH_TARGET_DIR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_TARGET_DIR_ABSPATH       $(BS_NOARCH_TARGET_DIR_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_DEPEND_DIR               $(BS_NOARCH_DEPEND_DIR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_DEPEND_DIR_ABSPATH       $(BS_NOARCH_DEPEND_DIR_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_FLAG_DIR                 $(BS_NOARCH_FLAG_DIR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BS_NOARCH_FLAG_DIR_ABSPATH         $(BS_NOARCH_FLAG_DIR_ABSPATH)")
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BRANCH_PROJECT                          $(BRANCH_PROJECT)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_BRANCH_ROOT_ABSPATH   $($(BRANCH_PROJECT)_BRANCH_ROOT_ABSPATH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_MAJOR             $($(BRANCH_PROJECT)_REV_MAJOR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_MINOR             $($(BRANCH_PROJECT)_REV_MINOR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_PATCH             $($(BRANCH_PROJECT)_REV_PATCH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_DATETIME          $($(BRANCH_PROJECT)_REV_DATETIME)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_SRCVER            $($(BRANCH_PROJECT)_REV_SRCVER)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_STRING            $($(BRANCH_PROJECT)_REV_STRING)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) \$$(BRANCH_PROJECT)_REV_FULL              $($(BRANCH_PROJECT)_REV_FULL)")
...
$(BS_NOARCH_TARGET_DIR): $(BS_ROOT_TARGET_DIR)
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $@
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_NOARCH_DEPEND_DIR)
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_NOARCH_FLAG_DIR)

$(BS_ARCH_TARGET_DIR): $(BS_ROOT_TARGET_DIR)
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $@
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_ARCH_DEPEND_DIR)
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_ARCH_FLAG_DIR)
