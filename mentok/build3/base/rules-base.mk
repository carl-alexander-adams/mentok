...
base_info:
	...
	@echo "$(BS_INFO_PREFIX) COMPONENT_ROOT_ABSPATH             $(COMPONENT_ROOT_ABSPATH)"
	...
	@echo "$(BS_INFO_PREFIX) BS_OS_RUNTIMENAME                  $(BS_OS_RUNTIMENAME)"
	@echo "$(BS_INFO_PREFIX) BS_OS_RUNTIMEREVMAJOR              $(BS_OS_RUNTIMEREVMAJOR)"
	@echo "$(BS_INFO_PREFIX) BS_OS_RUNTIMEREVMINOR              $(BS_OS_RUNTIMEREVMINOR)"
	@echo "$(BS_INFO_PREFIX) BS_OS_RUNTIMEREVPATCH              $(BS_OS_RUNTIMEREVPATCH)"
	@echo "$(BS_INFO_PREFIX) BS_OS_RUNTIMEOLDNAME               $(BS_OS_RUNTIMEOLDNAME)"
	...
	@echo "$(BS_INFO_PREFIX) BS_PLATFORM_ARCH_FALLBACK_5        $(BS_PLATFORM_ARCH_FALLBACK_5)"
	@echo "$(BS_INFO_PREFIX) BS_PLATFORM_ARCH_FALLBACK_6        $(BS_PLATFORM_ARCH_FALLBACK_6)"
	@echo "$(BS_INFO_PREFIX) BS_PLATFORM_ARCH_FALLBACK_7        $(BS_PLATFORM_ARCH_FALLBACK_7)"
	...
	@echo "$(BS_INFO_PREFIX) BIN_SHADOWTREE                     $(BIN_SHADOWTREE)"
	@echo "$(BS_INFO_PREFIX) BIN_SH                             $(BIN_SH)"
	@echo "$(BS_INFO_PREFIX) BIN_PRINTF                         $(BIN_PRINTF)"
	@echo "$(BS_INFO_PREFIX) BIN_ECHO                           $(BIN_ECHO)"
