...
BS_ARCH_FLAG_DIR=$(BS_ARCH_TARGET_DIR)/flags
BS_ARCH_DEPEND_DIR=$(BS_ARCH_TARGET_DIR)/depends

BS_NOARCH_FLAG_DIR=$(BS_NOARCH_TARGET_DIR)/flags
BS_NOARCH_DEPEND_DIR=$(BS_NOARCH_TARGET_DIR)/depends

BS_ARCH_FLAG_DIR_ABSPATH=$(BS_ARCH_TARGET_DIR_ABSPATH)/flags
BS_ARCH_DEPEND_DIR_ABSPATH=$(BS_ARCH_TARGET_DIR_ABSPATH)/depends

BS_NOARCH_FLAG_DIR_ABSPATH=$(BS_NOARCH_TARGET_DIR_ABSPATH)/flags
BS_NOARCH_DEPEND_DIR_ABSPATH=$(BS_NOARCH_TARGET_DIR_ABSPATH)/depends
