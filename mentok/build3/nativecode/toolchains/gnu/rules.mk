...
nativecode_toolchain_gnu_info:
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) Gnu Toolchain Settings")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) --------------------------------------------------")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CC                               $(BIN_GNU_CC)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CC_OUTPUTFLAG                    $(BIN_GNU_CC_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CXX                              $(BIN_GNU_CXX)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CXX_OUTPUTFLAG                   $(BIN_GNU_CXX_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_AS                               $(BIN_GNU_AS)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_AS_OUTPUTFLAG                    $(BIN_GNU_AS_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CPP                              $(BIN_GNU_CPP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_CPP_OUTPUTFLAG                   $(BIN_GNU_CPP_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_AR                               $(BIN_GNU_AR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_AR_OUTPUTFLAG                    $(BIN_GNU_AR_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_LD                               $(BIN_GNU_LD)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_LD_OUTPUTFLAG_EXE                $(BIN_GNU_LD_OUTPUTFLAG_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_LD_OUTPUTFLAG_SHLIB              $(BIN_GNU_LD_OUTPUTFLAG_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_LD_OUTPUTFLAG_INCOBJ             $(BIN_GNU_LD_OUTPUTFLAG_INCOBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_GNU_STRIP                            $(BIN_GNU_STRIP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_GNU_OBJ                       $(EXTENSIONS_GNU_OBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_GNU_EXE                       $(EXTENSIONS_GNU_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_GNU_LIB                       $(EXTENSIONS_GNU_LIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_GNU_SHLIB                     $(EXTENSIONS_GNU_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
...
nativecode_info_toolchains:: nativecode_toolchain_gnu_info
