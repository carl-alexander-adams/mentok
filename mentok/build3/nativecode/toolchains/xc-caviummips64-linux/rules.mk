...
nativecode_toolchain_xc_caviummips64_linux_info:
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) --------------------------------------------------")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) XC_CAVIUMMIPS64_LINUX_SDK_REVMAJOR             $(XC_CAVIUMMIPS64_LINUX_SDK_REVMAJOR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) XC_CAVIUMMIPS64_LINUX_SDK_REVMINOR             $(XC_CAVIUMMIPS64_LINUX_SDK_REVMINOR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) XC_CAVIUMMIPS64_LINUX_SDK_REVPATCH             $(XC_CAVIUMMIPS64_LINUX_SDK_REVPATCH)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) XC_CAVIUMMIPS64_LINUX_SDK_HOME                 $(XC_CAVIUMMIPS64_LINUX_SDK_HOME)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_CC_OUTPUTFLAG                    $(BIN_XC_CAVIUMMIPS64_LINUX_CC_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_CXX                              $(BIN_XC_CAVIUMMIPS64_LINUX_CXX)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_CXX_OUTPUTFLAG                   $(BIN_XC_CAVIUMMIPS64_LINUX_CXX_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_AS                               $(BIN_XC_CAVIUMMIPS64_LINUX_AS)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_AS_OUTPUTFLAG                    $(BIN_XC_CAVIUMMIPS64_LINUX_AS_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_CPP                              $(BIN_XC_CAVIUMMIPS64_LINUX_CPP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_CPP_OUTPUTFLAG                   $(BIN_XC_CAVIUMMIPS64_LINUX_CPP_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_AR                               $(BIN_XC_CAVIUMMIPS64_LINUX_AR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_AR_OUTPUTFLAG                    $(BIN_XC_CAVIUMMIPS64_LINUX_AR_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_LD                               $(BIN_XC_CAVIUMMIPS64_LINUX_LD)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_EXE                $(BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_SHLIB              $(BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_INCOBJ             $(BIN_XC_CAVIUMMIPS64_LINUX_LD_OUTPUTFLAG_INCOBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_XC_CAVIUMMIPS64_LINUX_STRIP                            $(BIN_XC_CAVIUMMIPS64_LINUX_STRIP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_XC_CAVIUMMIPS64_LINUX_OBJ                       $(EXTENSIONS_XC_CAVIUMMIPS64_LINUX_OBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_XC_CAVIUMMIPS64_LINUX_EXE                       $(EXTENSIONS_XC_CAVIUMMIPS64_LINUX_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_XC_CAVIUMMIPS64_LINUX_LIB                       $(EXTENSIONS_XC_CAVIUMMIPS64_LINUX_LIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_XC_CAVIUMMIPS64_LINUX_SHLIB                     $(EXTENSIONS_XC_CAVIUMMIPS64_LINUX_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
...
nativecode_info_toolchains:: nativecode_toolchain_xc_caviummips64_linux_info
