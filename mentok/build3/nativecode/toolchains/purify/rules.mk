...
nativecode_toolchain_purify_info:
	...
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) Purify Toolchain Settings")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) --------------------------------------------------")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CC                            $(BIN_PURIFY_CC)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CC_OUTPUTFLAG                 $(BIN_PURIFY_CC_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CXX                           $(BIN_PURIFY_CXX)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CXX_OUTPUTFLAG                $(BIN_PURIFY_CXX_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_AS                            $(BIN_PURIFY_AS)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_AS_OUTPUTFLAG                 $(BIN_PURIFY_AS_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CPP                           $(BIN_PURIFY_CPP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_CPP_OUTPUTFLAG                $(BIN_PURIFY_CPP_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_AR                            $(BIN_PURIFY_AR)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_AR_OUTPUTFLAG                 $(BIN_PURIFY_AR_OUTPUTFLAG)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_LD                            $(BIN_PURIFY_LD)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_LD_OUTPUTFLAG_EXE             $(BIN_PURIFY_LD_OUTPUTFLAG_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_LD_OUTPUTFLAG_SHLIB           $(BIN_PURIFY_LD_OUTPUTFLAG_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_LD_OUTPUTFLAG_INCOBJ          $(BIN_PURIFY_LD_OUTPUTFLAG_INCOBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) BIN_PURIFY_STRIP                         $(BIN_PURIFY_STRIP)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_PURIFY_OBJ                    $(EXTENSIONS_PURIFY_OBJ)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_PURIFY_EXE                    $(EXTENSIONS_PURIFY_EXE)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_PURIFY_LIB                    $(EXTENSIONS_PURIFY_LIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) EXTENSIONS_PURIFY_SHLIB                  $(EXTENSIONS_PURIFY_SHLIB)")
	@$(call BS_FUNC_ECHO_VERBOSE0,"$(BS_INFO_PREFIX) ")
...
nativecode_info_toolchains:: nativecode_toolchain_purify_info
