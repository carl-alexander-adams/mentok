...
#
COMPONENT_FUNC_GET_IMPORTRPM_FLAGTARGET=$(BS_ARCH_FLAG_DIR)/component_flags_importrpm/$(1)
...
_IMPORTRPM_DEPEND_FILE=$(BS_ARCH_DEPEND_DIR)/component_depend_importrpm.mk
...
_IMPORTRPM_DEP_PREP:
	...
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_ARCH_FLAG_DIR)/component_flags_importrpm
...
COMPONENT_FUNC_GET_BULKDIST_FLAGTARGET=$(BS_ARCH_FLAG_DIR)/component_flags_bulkdist/$(1)
...
_BULKDIST_DEPEND_FILE=$(BS_ARCH_DEPEND_DIR)/component_depend_bulkdist.mk
...
_BULKDIST_DEP_PREP:
	...
	$(BS_CMDPREFIX_VERBOSE2) $(BIN_MKDIR) -p $(BS_ARCH_FLAG_DIR)/component_flags_bulkdist
