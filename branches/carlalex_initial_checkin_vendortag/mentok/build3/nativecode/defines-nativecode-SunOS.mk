...
#
ifeq ($(BIN_GNU_CC),)
BIN_GNU_CC=/usr/local/gcc-3.1/bin/gcc
endif
ifeq ($(BIN_GNU_CXX),)
BIN_GNU_CXX=/usr/local/gcc-3.1/bin/g++
endif
ifeq ($(BIN_GNU_AS),)
BIN_GNU_AS=/usr/local/gcc-3.1/bin/gcc
endif
ifeq ($(BIN_GNU_CPP),)
BIN_GNU_CPP=/usr/local/gcc-3.1/bin/gcc -E
endif
ifeq ($(BIN_GNU_LD),)
BIN_GNU_LD=/usr/local/gcc-3.1/bin/gcc
endif
ifeq ($(BIN_GNU_AR),)
